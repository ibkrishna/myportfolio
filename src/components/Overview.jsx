...
function Overview() {
  ...
  return (
    <section className={`mt-14 py-10`}>
      ...
      >
        <div className="md:flex items-start justify-center lg:min-h-[90vh]">
            ...
            <div className="absolute md:bottom-2 bottom-0 right-2 md:right-10 lg:-translate-x-20 flex items-center space-x-2">
              <button
                className={`p-1 md:p-4 cursor-pointer flex items-center justify-around ${
                  isDarkMode
                    ? "bg-[#e9e1b4] lg:w-[160px] rounded-xl md:rounded-2xl text-black hover:bg-[#c3c0b1]"
                    : "border rounded-2xl border-[#191A23] text-[#14213d] hover:bg-[#c6c2b5]"
                }`}
              >
            ...
            <div className="absolute -left-4 md:left-12 md:top-1/2 transform md:-translate-y-1/2 flex items-center space-x-2">
              <button
                className={`p-2 md:p-4 cursor-pointer flex items-center justify-around ${
                  isDarkMode
                    ? "bg-[#e9e1b4] h-16 w-16 md:h-24 md:w-24 rounded-full text-black hover:bg-[#c3c0b1]"
                    : "border border-[#191A23] rounded-2xl text-[#14213d] hover:bg-[#c6c2b5]"
                }`}
          ...
          <div className="md:pl-6 mt-4 md:mt-0 md:w-1/2">
            <div className="sticky top-0">
              ...
              <h2 className="text-lg md:text-2xl lg:text-3xl mb-6">
