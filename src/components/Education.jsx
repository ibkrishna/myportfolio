  ...
  return (
    <section className="mt-14 py-10">
      <div style={{ fontFamily: "Inria Sans" }}>
        <div className={`lg:min-h-[90vh] lg:grid  ${isDarkMode ? 'bg-[#FFFFFF26]' : 'bg-[#f7f7f7] '} p-6 rounded-2xl mx-4 md:mx-6 lg:mx-24`}>
          <h1
          ...
          <div className="space-y-6 py-10 md:mx-14 lg:mx-20 md:p-6">
